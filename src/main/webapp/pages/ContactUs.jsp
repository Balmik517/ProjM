...
<body>
	...
	<div id="main-body"
		...
		<form class="form" action="contact" method="post">
			<h2 align='center'>
				<strong>Contact Us for any query</strong>
			</h2>
			<hr style="color: rgb(255, 249, 249); height: 3px;">
			<div class="form-group">
				<i class="fa fa-user fa-lg me-3 fa-fw"></i> <label>Name :</label> <input
					type="text" name="name"><br>
			</div>
			<div class="form-group">
				<i class="fa fa-envelope fa-lg me-3 fa-fw"></i> <label>Email
					:</label> <input type="email" name="email"><br>
			</div>
			<div class="form-group">
				<i class="fa fa-phone fa-lg me-3 fa-fw"></i> <label>Contact
					No :</label> <input type="number" name="number"><br>
			</div>
			<div class="form-group">
				<i class="fa fa-question fa-lg me-3 fa-fw"></i> <label>Your
					Query :</label>
