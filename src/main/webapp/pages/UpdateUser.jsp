	...
	<div id="main-body">
		...
		<form class="form" action="updateUserData" method="post">
			...
			<div class="form-group">
				<label>Id :</label> <input style="color:gray;" type="text" name="id"
					value="${userKey.id}" readonly="readonly"><br>
			</div>
			<div class="form-group">
				<label>Name :</label> <input type="text" name="name"
					value="${userKey.name}" style="color:gray;" readonly="readonly"><br>
			</div>
			<div class="form-group">
				<label>Date of Birth :</label> <input type="date" name="dob"
					value="${userKey.dob}" style="color:gray;" readonly="readonly"><br>
			</div>
			<div class="form-group">
				<label>Address :</label>
				<textarea name="address" id="" cols="30" rows="10"
					value="${userKey.address}"></textarea>
			</div>
			<br> <br>
			<div class="form-group">
				<label>Phone number :</label> <input type="number"
					name="phoneNumber" value="${userKey.phoneNumber}"><br>
			</div>
			<div class="form-group">
				<label>Email :</label> <input type="email" name="email"
					value="${userKey.email}" style="color:gray;" readonly="readonly"><br>
			</div>
			<div class="form-group">
				<label>Password :</label> <input type="password" name="password"
					value="${userKey.password}"><br>
			</div>
